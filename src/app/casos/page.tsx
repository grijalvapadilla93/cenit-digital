  ...
  websites: [
    {
      ...
      description: "Sitio web diseñado para convertir visitantes en reservaciones. Menú digital interactivo, sistema de reservas integrado y botón de WhatsApp visible en todo momento. Diseño oscuro y elegante.",
    ...
    },
    {
      ...
      description: "Web completa para complejo que incluye restaurante, bar y academia ecuestre. Galería de eventos, caballos, academia y sistema de contacto directo. Diseño premium con animaciones de scroll.",
  ...
  chatbots: [
    {
      ...
      category: "IA · Restaurante · Guatemala",
      description: "Chatbot que responde WhatsApp e Instagram al instante. Agenda citas, responde preguntas sobre el menú, horarios y precios. El dueño solo revisa el calendario por la mañana.",
    ...
    },
    {
      ...
      description: "Sistema de IA que agenda citas, responde preguntas frecuentes y deriva emergencias. Integración directa con calendario del negocio. Reduce llamadas telefónicas en horario laboral.",
    ...
    },
    {
      ...
      category: "IA · E-commerce · Guatemala",
      description: "Bot que muestra catálogo, confirma stock, toma pedidos y envía link de pago. El cliente nunca sale de WhatsApp. La tienda dejó de perder ventas fuera de horario.",
  ...
  automations: [
    {
      ...
      description: "Pedidos de WhatsApp se convierten automáticamente en órdenes para cocina. Notificaciones al cliente con tiempo estimado. Resumen diario de ventas enviado al dueño a las 10 PM.",
    ...
    },
    {
      ...
      description: "Cada persona que escribe por cualquier canal entra al sistema. Recibe seguimiento automático por WhatsApp durante 7 días. El vendedor solo se encarga de los que están listos para comprar.",
    ...
    },
    {
      ...
      category: "Automatización · Servicios · Guatemala",
      description: "Recordatorio de cita 24h antes por WhatsApp. Aviso de pago pendiente a los 5 días. Felicitación de cumpleaños con descuento. Todo automático, todo personalizado con el nombre del cliente.",
      result: "-60% en no-shows y pagos atrasados",
      url: "/ai",
      image: "/casos/yeguada10/hero.jpeg",
    },
  ],
  dashboards: [
    {
      ...
      description: "Ventas del día, semana y mes en tiempo real. Productos más vendidos, horarios pico, comparativa con mes anterior. El dueño ve todo en 30 segundos desde su celular.",
    ...
    },
    {
      ...
      description: "Mesas ocupadas, reservas del día, cancelaciones y no-shows. Predicción de ocupación para la semana. El dueño sabe cuánto personal necesita antes de abrir.",
    ...
    },
    {
      ...
      category: "Dashboard · Marketing · Guatemala",
      description: "Cuántos clientes vienen de Instagram, Google, Facebook y boca a boca. Costo por lead por canal. ROI de cada publicación. Sabés dónde invertir y dónde dejar de gastar.",
      result: "+30% en eficiencia de inversión publicitaria",
      url: WHATSAPP_LINK,
      image: "/casos/alejandro-requena/hero.jpeg",
    },
  ],
